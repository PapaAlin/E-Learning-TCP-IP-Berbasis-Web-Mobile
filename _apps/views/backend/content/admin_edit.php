            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <form method="post" enctype="multipart/form-data" name="form1" id="form1" action="<?=base_url()?>adm/admins/edit_save">
                    <input type="hidden" name="admin_id" value="<?=$view_admin->admin_id?>">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="admin_status">
                          <option value="1" <?php if($view_admin->admin_status == "1") echo "selected" ?>>Admin</option>
                          <option value="2" <?php if($view_admin->admin_status == "2") echo "selected" ?>>Super Admin</option>
                        </select>
                      </div>
                    </div>
