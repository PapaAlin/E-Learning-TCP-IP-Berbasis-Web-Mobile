            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-body pad">
                  <form method="post" enctype="multipart/form-data" name="form1" id="form1" action="<?=base_url()?>adm/courses/add_save">

                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Judul Courses :</label>
                        <input type="text" name="course_title" class="form-control" placeholder="Masukkan Judul Courses" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="course_desc" rows="8" cols="80"></textarea>
                      </div>
                    </div>
