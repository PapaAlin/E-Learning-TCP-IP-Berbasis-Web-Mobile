...
<link rel="stylesheet" href="<?=base_url()?>_assets/_main/css/lightbox.css" type="text/css" media="all" /><!--gallery-popup-css-->
<link href="<?=base_url()?>_assets/_main/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" /><!-- Pop-up -->
...
<!-- banner -->
  <div class="banner" id="home" >
      ...
      <div class="banner-image-w3layouts">
        <img src="<?=base_url()?>_assets/_main/images/men.png" alt=" " class="img-responsive" />
      </div>
  </div>
<!-- //banner -->
<!-- about -->
      ...
      <div class="container">
        <div class="col-md-4 agileits_service_grid_btm_left">
          <div class="agileits_service_grid_btm_left1">
            ...
            <img src="<?=base_url()?>_assets/_main/images/4.jpg" alt=" " class="img-responsive" />
          </div>
        </div>
        <div class="col-md-4 agileits_service_grid_btm_left">
          <div class="agileits_service_grid_btm_left1">
            ...
            <img src="<?=base_url()?>_assets/_main/images/5.jpg" alt=" " class="img-responsive" />
          </div>
        </div>
        <div class="col-md-4 agileits_service_grid_btm_left">
          <div class="agileits_service_grid_btm_left1">
            ...
            <img src="<?=base_url()?>_assets/_main/images/6.jpg" alt=" " class="img-responsive" />
          </div>
        </div>
        <div class="clearfix"> </div>
      </div>
    ...
    <div class="gallery_grid agileits_w3layouts">
      ...
      <div class="grid-1">
        <a class="cm-overlay" href="images/gg1.jpg">
          <img src="<?=base_url()?>_assets/_main/images/gg1.jpg" alt=" " class="img-responsive" />
       ...
       <div class="sub_grid gallery_w3l">
           <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-c grid_w3l">
            <a class="cm-overlay" href="images/gg2.jpg">
              <img src="<?=base_url()?>_assets/_main/images/gg2.jpg" alt=" " class="img-responsive" />
           ...
           <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-b grid_w3l">
            <a class="cm-overlay" href="images/gg3.jpg">
              <img src="<?=base_url()?>_assets/_main/images/gg3.jpg" alt=" " class="img-responsive" />
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 grid_w3">
       <div class="sub_grid">
         <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-c grid_w3l">
            ...
            <img src="<?=base_url()?>_assets/_main/images/gg4.jpg" alt=" " class="img-responsive" />
            <div class="w3agile-text w3agile-text-small full-height-w3">
              <h5>Project 4</h5>
            </div>
          </a>
         ...
         <div class="col-md-6 col-sm-6 col-xs-6 grid-1 grid-d grid_w3l">
          <a class="cm-overlay" href="images/gg5.jpg">
            <img src="<?=base_url()?>_assets/_main/images/gg5.jpg" alt=" " class="img-responsive" />
            <div class="w3agile-text w3agile-text-smal1 full-height-w3">
              <h5>Project 5</h5>
            </div>
          </a>
        ...
        <a class="cm-overlay" href="images/gg6.jpg">
          <img src="<?=base_url()?>_assets/_main/images/gg6.jpg" alt=" " class="img-responsive" />
          <div class="w3agile-text w3agile-text-smal1">
              <h5>Project 6</h5>
          </div>
        </a>
...
<!-- js -->
<script type="text/javascript" src="<?=base_url()?>_assets/_main/js/jquery-2.1.4.min.js"></script>
...
<!-- //menu -->
<!-- Gallery-plugin -->
<script src="<?=base_url()?>_assets/_main/js/jquery.mobile.custom.min.js"></script>
<script src="<?=base_url()?>_assets/_main/js/jquery.cm-overlay.js"></script>
    <script>
      $(document).ready(function(){
...
<!-- //Gallery-plugin -->
<!-- responsiveslides -->
<script src="<?=base_url()?>_assets/_main/js/responsiveslides.min.js"></script>
      <script>
...
<!-- //responsiveslides -->
  ...
  <!-- //Navigation-JavaScript -->
<!--pop-up-box -->
          <script src="<?=base_url()?>_assets/_main/js/jquery.magnific-popup.js" type="text/javascript"></script>
          <script>
          $(document).ready(function() {
...
<!-- banner-type-text -->
  <script src="<?=base_url()?>_assets/_main/js/typed.js" type="text/javascript"></script>
    <script>
    $(function(){
...
<script type="text/javascript" src="<?=base_url()?>_assets/_main/js/move-top.js"></script>
<script type="text/javascript" src="<?=base_url()?>_assets/_main/js/easing.js"></script>
<script type="text/javascript">
...
<script type="text/javascript" src="<?=base_url()?>_assets/_main/js/bootstrap-3.1.1.min.js"></script>
