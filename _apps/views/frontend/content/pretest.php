    ...
    <div class="container">
      ...
      <div class="about-sub">        
        ...
        <div class="col-md-12 about_bottom_left">
          ...
          <form method="post" enctype="multipart/form-data" action="<?=base_url()?>courses/pretest_save?">
            ...
            <input type="hidden" name="jawaban_type" value="pretest">
